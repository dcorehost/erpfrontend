...
const recentActivities = [
  ...
  {
    id: 2,
    action: "New task assigned to Team A",
    time: "15 mins ago",
    icon: "📌",
  },
  ...
  {
    id: 4,
    action: "Attendance marked for 120 users",
    time: "3 hours ago",
    icon: "📅",
  },
  {
  ...
  useEffect(() => {
    ...
    const fetchTaskStatusData = async () => {
      try {
        ...
        const [todoRes, inProgressRes, doneRes, submittedRes, completedRes] =
          await Promise.all([
        ...
        const formattedData = [
          ...
          {
            name: "In Progress",
            value: inProgressRes.data.taskCount,
            fill: "#64B5F6",
          },
          { name: "Done", value: doneRes.data.taskCount, fill: "#81C784" },
          {
            name: "Submitted for Review",
            value: submittedRes.data.taskCount,
            fill: "#BA68C8",
          },
          {
            name: "Completed",
            value: completedRes.data.taskCount,
            fill: "#4CAF50",
          },
        ];
    ...
    const fetchLeaveStatusData = async () => {
      try {
        ...
        const [pendingRes, rejectedRes, completedRes] = await Promise.all([
        ...
        const formattedData = [
          {
            name: "Pending",
            value: pendingRes.data.leaveCount,
            fill: "#FFC107",
          },
          {
            name: "Rejected",
            value: rejectedRes.data.leaveCount,
            fill: "#F44336",
          },
          {
            name: "Completed",
            value: completedRes.data.leaveCount,
            fill: "#4CAF50",
          },
        ];
    ...
    const fetchAttendanceStatusData = async () => {
      try {
        ...
        const formattedData = [
          {
            name: "Present",
            value: presentRes.data.dailyAttendanceCount,
            fill: "#4CAF50",
          },
          {
            name: "Late",
            value: lateRes.data.lateAttendanceCount,
            fill: "#FFC107",
          },
          {
            name: "Absent",
            value: absentRes.data.absentCount,
            fill: "#F44336",
          },
        ];
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.recentActivities}>
          <div className={styles.sectionHeader}>
            ...
            <Link to="/activities" className={styles.viewAll}>
              View All →
            </Link>
          </div>
...
const DashboardLink = ({ to, title }) => (
  <Link to={to} className={styles.cardLink}>
    <div className={styles.linkContent}>{title}</div>
  </Link>
);
