...
const NotificationForm = ({
  ...
  return (
    <div
      className={`${styles["create-container"]} ${styles[`${userType}-panel`]}`}
    >
...
const AdminPanel = () => {
  ...
  const handleCreateNotification = async (e) => {
    ...
    if (!title || !message || !targetRoles.length) {
      setFormStatus({
        error: "Title, message, and at least one role are required.",
        success: "",
      });
    ...
    >
      <div className={styles["navigation-tabs"]}>
        <button
          className={`${styles["tab-button"]} ${
            currentPage === "view" ? styles.active : ""
          }`}
      ...
      {currentPage === "create" ? (
        <NotificationForm
          ...
          setTitle={(value) =>
            handleFormChange({ target: { name: "title", value } })
          }
          ...
          setNotificationType={(value) =>
            handleFormChange({ target: { name: "notificationType", value } })
          }
